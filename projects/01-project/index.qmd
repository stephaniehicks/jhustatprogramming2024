...
1. Use [`wget`](https://www.gnu.org/software/wget) to download the `students.csv` file from [here](https://github.com/stephaniehicks/jhustatprogramming2024/projects/01-project/raw/main/data/students.csv)
...
9. Find the unique subjects listed in the file. Use `cut` and `sort | uniq` to extract unique subjects.
