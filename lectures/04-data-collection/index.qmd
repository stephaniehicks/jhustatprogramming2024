...
- Use `html_table` to extract a table containing the World Cup champions and the corresponding runner-up for each World Cup year. This is the first table under "Results". 
...
- Use `html_elements()` to select the list of references (`<".references li">` tags). 
